...
主要记录服务端错误
 */
@Entity(listener = XapErrlogListener.class)
@Table(name = "XAP_ERRLOG")
public class XapErrlog {
    ...
    /** 
     * Returns the errlogPk.
     * 
     * @return the errlogPk
     */
    public String getErrlogPk() {
        return errlogPk;
    }
     ...
     * Sets the errlogPk.
     * 
     * @param errlogPk the errlogPk
     */
    public void setErrlogPk(String errlogPk) {
        this.errlogPk = errlogPk;
    }
