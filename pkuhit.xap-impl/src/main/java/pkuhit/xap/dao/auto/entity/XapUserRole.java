 ...
 * 用户角色
 */
@Entity(listener = XapUserRoleListener.class)
@Table(name = "XAP_USER_ROLE")
public class XapUserRole {
    ...
    /** 
     * Returns the userRoleCd.
     * 
     * @return the userRoleCd
     */
     ...
     * Sets the userRoleCd.
     * 
     * @param userRoleCd the userRoleCd
     */
