 ...
 * 角色  门户
 */
@Entity(listener = XapRolePortalListener.class)
@Table(name = "XAP_ROLE_PORTAL")
public class XapRolePortal {
    ...
    /** 
     * Returns the rolePoCd.
     * 
     * @return the rolePoCd
     */
    public String getRolePoCd() {
        return rolePoCd;
    }
     ...
     * Sets the rolePoCd.
     * 
     * @param rolePoCd the rolePoCd
     */
    public void setRolePoCd(String rolePoCd) {
        this.rolePoCd = rolePoCd;
    }
