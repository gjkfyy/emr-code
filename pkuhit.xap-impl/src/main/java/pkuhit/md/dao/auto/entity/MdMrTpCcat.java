...
public class MdMrTpCcat {
    ...
    /** 
     * Returns the parMrTpCcatCd.
     * 
     * @return the parMrTpCcatCd
     */
    public String getParMrTpCcatCd() {
        return parMrTpCcatCd;
    }

    /** 
     * Sets the parMrTpCcatCd.
     * 
     * @param parMrTpCcatCd the parMrTpCcatCd
     */
    public void setParMrTpCcatCd(String parMrTpCcatCd) {
        this.parMrTpCcatCd = parMrTpCcatCd;
    }
