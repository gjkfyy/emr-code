 ...
 * MD_MR_STA
 */
@Entity(listener = MdMrStaListener.class)
@Table(name = "MD_MR_STA")
public class MdMrSta {
    ...
    /** 
     * Returns the nextMrStaCd.
     * 
     * @return the nextMrStaCd
     */
    public String getNextMrStaCd() {
        return nextMrStaCd;
    }

    /** 
     * Sets the nextMrStaCd.
     * 
     * @param nextMrStaCd the nextMrStaCd
     */
    public void setNextMrStaCd(String nextMrStaCd) {
        this.nextMrStaCd = nextMrStaCd;
    }

    /** 
     * Returns the preMrStaCd.
     * 
     * @return the preMrStaCd
     */
    public String getPreMrStaCd() {
        return preMrStaCd;
    }
     ...
     * Sets the preMrStaCd.
     * 
     * @param preMrStaCd the preMrStaCd
     */
    public void setPreMrStaCd(String preMrStaCd) {
        this.preMrStaCd = preMrStaCd;
    }
