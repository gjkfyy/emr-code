...
public interface AssVitalsignService {
	/**
	 *  【生命体征】查询服务（单记录）为宏元素
	 * @param String enPk 就诊主键
	 * @return Vitalsign
	 */ 
	@RequestMapping(value = "/nu/vitalsigns/macro", method = RequestMethod.GET)
	 ...
	 */ 
	@RequestMapping(value = "/nursing/vitalsign/{vitalSignPk}", method = RequestMethod.GET)
	SingleResult<Vitalsign> search(@PathVariable("vitalSignPk")  String vitalSignPk   ,@RequestParam ("enTypeCode") String enTypeCode) ;
	 ...
	 */
	@RequestMapping(value = "/nu/vitalsigns", method = RequestMethod.GET)
