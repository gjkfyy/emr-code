...
import pkuhit.iih.nu.VitalsignService;
import pkuhit.xap.pm.ParamsSetService;
import szlh.iih.nu.dao.VitalsignDao;
...
public class VitalsignServiceImpl implements VitalsignService {
	...
	public ArrayResult<Vitalsign> search(String enPk,String  acquisitionStartTime,String acquisitionStopTime,String currentPageIndex,String pageSize) {
		...
		)	
		{
			...
			List<VitalsignPo> poList = this.vitalsignDao.getAcquisitionListByEnSn(null,patientId,times, acquisitionStartTime, acquisitionStopTime,"desc"/*,options*/);
	...
	public SingleResult<Vitalsign> searchRecodeForMacro(String enPk) {
		...
		List<VitalsignPo> poList = this.vitalsignDao.getAcquisitionListByEnSn(enPk,patientId,times, null, null,null/*,options*/);
		Vitalsign vo = new Vitalsign();
		SingleResultBuilder<Vitalsign> builder = SingleResultBuilder.newSingleResult(Vitalsign.class);
