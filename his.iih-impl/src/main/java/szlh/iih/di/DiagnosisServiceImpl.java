...
import szlh.iih.di.dao.MzPatientDiagnosisEntityDao;
...
public class DiagnosisServiceImpl implements DiagnosisService {
	...
	public ArrayResult<DiagnosisModel> search(String enPk, String isMainF,String onlyNotStop, String currentPageIndex , String pageSize ) {
		logger.debug("encounterSn:"+enPk+",isMainF:"+isMainF+",onlyNotStop:"+onlyNotStop+",currentPageIndex:"+currentPageIndex+",pageSize:"+pageSize);
		...
		if(enPk.contains("_")){
			...
			List<DiagnosisPo> poList = this.diDao.getDisListByEnSn(null,patientId,times,onlyMainF,onlyNotStop,options);
			...
			logger.error("en_sn is not contains '_'");
		}
	...
	public void saveOrUpdateDiagnosis(HisDiagnosisListModel src,
		...
		ArrayResult<DiagnosisModel> hisDiArrayResult = search(enPk,null,null,null,null);
		//HIS数据库数据
