...
//    	String token = "NDkxMHxkMjJmMDFjYTE2ZjA0YTZkOTVhOGI4NTg1ZjE5YTk1ZXxYQVBNMDYuMDN8U1pMSHw0MzA5fDB8fDF8MTQyODAyNTY2MDYxNHw4MUR";
//    	String str = new String(Base64.decodeBase64(token));
    	
    	String paramString = "a1058|M4gP|XAPM06.08|SZLH|9010002||001234567800_180||1426139421624|M4gP";
    	String para = Base64.encodeBase64String(paramString.getBytes());	
    	String paramString1 = "finish|001234567800_180|1";
    	String para1 = Base64.encodeBase64String(paramString1.getBytes());	
//    	http://172.18.72.10:8086/iemr/ws/bridge?token=YTEwNTh8TTRnUHxYQVBNMDYuMDh8U1pMSHw5MDEwMDAyfHwwMDEyMzQ1Njc4MDBfMTgwfHwxNDI2MTM5NDIxNjI0fE00Z1A=
//    	System.out.println("token :"+token);
//    	System.out.println("base64 decode:"+str);
    	System.out.println("paramString :"+paramString);
    	System.out.println("base64 encode:"+para);
    	System.out.println("paramString :"+paramString1);
    	System.out.println("base64 encode:"+para1);
	}
}
