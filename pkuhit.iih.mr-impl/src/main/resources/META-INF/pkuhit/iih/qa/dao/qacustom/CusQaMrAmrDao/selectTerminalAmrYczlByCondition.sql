select 
 ...
 /*%if qaTypeCode != null && qaTypeCode != "" && qaTypeCode == "QAM13.02"*/
  ...
  inner join mr_tpl p on mr.mr_tpl_cd = p.mr_tpl_cd and p.del_f='0'
 ...
 where 1=1  
  ...
  /*%end*/
  /*%if specialMr != null && specialMr == "19" */
 and p.mr_tp_cd ='MRM16.18' and p.nm like '%有创诊疗%'
  /*%end*/
   /*%if specialMr != null && specialMr == "20" */
 and p.mr_tp_cd ='MRM16.21' and p.nm like '%疑难病例%' 
  /*%end*/
   /*%if specialMr != null && specialMr == "21" */
 and p.mr_tp_cd ='MRM16.30' and p.nm like '%多学科会诊%'
  /*%end*/
