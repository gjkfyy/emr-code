select 
 ...
 where 1=1  
  ...
  /*%end */
  /*%if terminalQaStaCd != null && terminalQaStaCd != ""*/
  and amr.TERMINAL_QA_STA_CD = /*terminalQaStaCd*/'1'
  /*%elseif  deptQaStaCd != "MRM22.04" */
  and amr.TERMINAL_QA_STA_CD is  null
  /*%end */
  
   /*%if deptQaStaCd != null && deptQaStaCd != ""*/
  and amr.DEPT_QA_STA_CD = /*deptQaStaCd*/'1'  
   /*%elseif  qaTypeCode == "QAM13.02" */
  and amr.DEPT_QA_STA_CD is  null
  /*%end */
