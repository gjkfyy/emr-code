select 
  ...
  from MR_AMR amr
  inner join en_adt b on amr.en_pk = b.en_pk
  --inner join "zy_adt"@dg4msql b on amr.pa_id = b."patient_id" and amr.en_cnt = b."admiss_times" and b."trans_times" > 0  
  /*%if specialMr != null && specialMr != "" && specialMr =="17"*/
    and (b.orig_dept = '1006010' or b.curr_dept = '1006010')
  /*%end */
