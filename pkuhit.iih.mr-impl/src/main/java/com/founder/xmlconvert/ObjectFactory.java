 ...
 * generated in the com.founder.xmlconvert package. 
...
public class ObjectFactory {
    ...
    private final static QName _ConvertResponse_QNAME = new QName("xmlconvert.founder.com", "convertResponse");
    private final static QName _Convert_QNAME = new QName("xmlconvert.founder.com", "convert");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.founder.xmlconvert
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "xmlconvert.founder.com", name = "convertResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "xmlconvert.founder.com", name = "convert")
