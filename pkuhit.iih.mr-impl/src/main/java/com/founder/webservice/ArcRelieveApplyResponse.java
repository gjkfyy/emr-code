...
@XmlRootElement(name = "ArcRelieveApplyResponse")
public class ArcRelieveApplyResponse {

    @XmlElementRef(name = "return", namespace = "http://webservice.founder.com", type = JAXBElement.class)
