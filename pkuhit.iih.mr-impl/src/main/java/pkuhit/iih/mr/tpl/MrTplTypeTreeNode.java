...
public class MrTplTypeTreeNode  extends BaseNode<TemplateNavigatorTreeData>  {
	CusGroupElementDao cusGroupElementDao = null;
	/**
	 * @param data
	 * @param condition
	 */
	public MrTplTypeTreeNode(TemplateNavigatorTreeData data,
			Map<String, String> condition) {
		super(data, condition);
		// TODO Auto-generated constructor stub
		
		data.setNodeType(TemplateNavigatorTreeNodeType.MRTYPE);
	...
	public void loadChildren() {
		...
		for(MrGe item:geList) {
			...
			MrTplLeafNode elementNode = new MrTplLeafNode(treeData, this.getCondition());
	...
	public String getText() {
		return this.getData().getTemplateTypeName();
	}
}
