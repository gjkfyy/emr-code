 ...
 * 就诊组表
 */
@Entity(listener = MrAmrGroupListener.class)
@Table(name = "MR_AMR_GROUP")
public class MrAmrGroup {
    ...
    /** 
     * Returns the mrAmrGroupCd.
     * 
     * @return the mrAmrGroupCd
     */
    ...
    /** 
     * Sets the mrAmrGroupCd.
     * 
     * @param mrAmrGroupCd the mrAmrGroupCd
     */
