 ...
 * 医疗记录模板_诊断
 */
@Entity(listener = MrTplDiListener.class)
@Table(name = "MR_TPL_DI")
public class MrTplDi {
    ...
    /** 
     * Returns the mrTplDiCd.
     * 
     * @return the mrTplDiCd
     */
    public String getMrTplDiCd() {
        return mrTplDiCd;
    }
     ...
     * Sets the mrTplDiCd.
     * 
     * @param mrTplDiCd the mrTplDiCd
     */
    public void setMrTplDiCd(String mrTplDiCd) {
        this.mrTplDiCd = mrTplDiCd;
    }
