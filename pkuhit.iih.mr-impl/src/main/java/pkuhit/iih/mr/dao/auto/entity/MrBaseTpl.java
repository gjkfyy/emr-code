 ...
 * 基础模板
 */
@Entity(listener = MrBaseTplListener.class)
@Table(name = "MR_BASE_TPL")
public class MrBaseTpl {
    ...
    /** 
     * Returns the paperTpCd.
     * 
     * @return the paperTpCd
     */
    public String getPaperTpCd() {
        return paperTpCd;
    }

    public String getMrBaseTplStaCd() {
		return mrBaseTplStaCd;
	}

	public void setMrBaseTplStaCd(String mrBaseTplStaCd) {
		this.mrBaseTplStaCd = mrBaseTplStaCd;
	}

	/** 
     * Sets the paperTpCd.
     * 
     * @param paperTpCd the paperTpCd
     */
    public void setPaperTpCd(String paperTpCd) {
        this.paperTpCd = paperTpCd;
    }
