 ...
 * 评分等级
 */
@Entity(listener = QaDivideLevelListener.class)
@Table(name = "QA_DIVIDE_LEVEL")
public class QaDivideLevel {

    /** 评分等级 */
    @Id
    @Column(name = "QA_DIVIDE_LEVEL_CD")
    String qaDivideLevelCd;
    ...
    /** 
     * Returns the qaDivideLevelCd.
     * 
     * @return the qaDivideLevelCd
     */
    ...
    /** 
     * Sets the qaDivideLevelCd.
     * 
     * @param qaDivideLevelCd the qaDivideLevelCd
     */
