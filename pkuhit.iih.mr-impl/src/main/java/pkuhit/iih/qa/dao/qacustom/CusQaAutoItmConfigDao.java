...
@Dao
@RepositoryConfig
public interface CusQaAutoItmConfigDao {
	 ...
	 */   
	@Select
	List<Map<String, Object>> selectQaAutoItmByCondition(String qaItmCd,String qaItmTpCd );
	
	@Select  
	QaAutoItmConfig selectByQaItmCd(String qaItmCd);
