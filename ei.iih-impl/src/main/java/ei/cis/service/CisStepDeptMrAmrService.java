 ...
 * 跨科处置就诊列表
 */
public interface CisStepDeptMrAmrService {
	 ...
	 * */
		@RequestMapping(value = "/ei/mramr/stepdept/cis/zy", method = RequestMethod.GET)
	   List<Map<String, Object>> getZYList(
		 ...
		 * @param stepEndTime   跨科处置区间结束时间
		 * */
			@RequestMapping(value = "/ei/mramr/stepdept/cis/mz", method = RequestMethod.GET)
