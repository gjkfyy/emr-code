...
import ei.ass.nu.mz.dao.MzSplitVitalsignDao;
 ...
 *
 */
public class MzSplitVitalsignServiceImpl implements MzSplitVitalsignService {
	...
	@Autowired
	MzSplitVitalsignDao vitalsignDao;
	/* (non-Javadoc)
