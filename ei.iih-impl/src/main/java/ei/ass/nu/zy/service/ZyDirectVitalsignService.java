...
public interface ZyDirectVitalsignService {
	/**
	 *  【生命体征】查询服务（单记录）为宏元素
	 * @param String enPk 就诊主键
	 * @return Vitalsign
	 */ 
	@RequestMapping(value = "/nu/zy/direct/vitalsigns/macro", method = RequestMethod.GET)
	 ...
	 */ 
	@RequestMapping(value = "/nursing/zy/direct/vitalsign/{vitalSignPk}", method = RequestMethod.GET)
	 ...
	 */
	@RequestMapping(value = "/nu/zy/direct/vitalsigns", method = RequestMethod.GET)
