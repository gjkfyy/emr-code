...
import ei.ass.nu.zy.dao.ZyDirectVitalsignDao;
 ...
 *
 */
public class ZyDirectVitalsignServiceImpl implements ZyDirectVitalsignService {

	@Autowired
	ZyDirectVitalsignDao vitalsignDao;
	/* (non-Javadoc)
