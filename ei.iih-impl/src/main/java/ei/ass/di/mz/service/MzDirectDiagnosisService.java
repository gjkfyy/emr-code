...
public interface MzDirectDiagnosisService {
	 ...
	 */
	@RequestMapping(value = "/diagnosises/mz/direct", method = RequestMethod.GET)
	 ...
	 */
	@RequestMapping(value = "/diagnosis/mz/direct/{id}", method = RequestMethod.GET)
	 ...
	 * http://localhost:8081/diagnosticsDetail/522119?xmode=debug
	 */
	@RequestMapping(value = "/diagnosis/syschronize2his/mz/direct", method = RequestMethod.GET)
	void saveOrUpdateDiagnosis(@ModelAttribute HisDiagnosisListModel list,@RequestParam("enPk") String enPk);
	 ...
	 * @param times 患者就诊次数
	 * */
	@RequestMapping(value = "/diagnosis/his/delete/mz/direct", method = RequestMethod.GET)
	void delDiagnosis(@RequestParam("delDiCode") String delDiCode,@RequestParam("mainDiCode") String mainDiCode,@RequestParam("enPk") String enPk);
