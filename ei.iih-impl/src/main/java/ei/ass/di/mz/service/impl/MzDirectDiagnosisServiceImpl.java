...
import ei.ass.di.mz.dao.MzDirectDiDao;
...
public class MzDirectDiagnosisServiceImpl implements MzDirectDiagnosisService {
	final static Logger logger = LoggerFactory.getLogger(MzDirectDiagnosisServiceImpl.class);
	@Autowired
	MzDirectDiDao diDao ;
	...
	@Override
	public void saveOrUpdateDiagnosis( HisDiagnosisListModel list,String enPk) {
