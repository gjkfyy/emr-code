...
public interface MzSplitDiagnosisService {

	/**
	 * 根据“患者+就诊次数”序号，获取诊断列表
	 ...
	 */
	@RequestMapping(value = "/diagnosises/mz/split", method = RequestMethod.GET)
	ArrayResult<DiagnosisModel> search(@RequestParam("patientId") String patient_id,@RequestParam("times") String times,@RequestParam("isMainF") String isMainF,@RequestParam("onlyNotStop") String onlyNotStop,@RequestParam("currentPageIndex") String currentPageIndex ,@RequestParam("pageSize") String pageSize );
	 ...
	 */
	@RequestMapping(value = "/diagnosis/mz/split/{id}", method = RequestMethod.GET)
	 ...
	 * http://localhost:8081/diagnosticsDetail/522119?xmode=debug
	 */
	@RequestMapping(value = "/diagnosis/syschronize2his/mz/split", method = RequestMethod.GET)
	 ...
	 * @param times 患者就诊次数
	 * */
	@RequestMapping(value = "/diagnosis/his/delete/mz/split", method = RequestMethod.GET)
