...
public interface ZyDirectDiagnosisService {
	 ...
	 */
	@RequestMapping(value = "/diagnosises/zy/direct", method = RequestMethod.GET)
	 ...
	 */
	@RequestMapping(value = "/diagnosis/zy/direct/{id}", method = RequestMethod.GET)
	 ...
	 * http://localhost:8081/diagnosticsDetail/522119?xmode=debug
	 */
	@RequestMapping(value = "/diagnosis/syschronize2his/zy/direct", method = RequestMethod.GET)
	 ...
	 * @param times 患者就诊次数
	 * */
	@RequestMapping(value = "/diagnosis/his/delete/zy/direct", method = RequestMethod.GET)
