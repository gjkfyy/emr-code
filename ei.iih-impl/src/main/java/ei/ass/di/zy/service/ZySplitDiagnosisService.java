...
public interface ZySplitDiagnosisService {
	 ...
	 */
	@RequestMapping(value = "/diagnosises/zy/split", method = RequestMethod.GET)
	 ...
	 */
	@RequestMapping(value = "/diagnosis/zy/split/{id}", method = RequestMethod.GET)
	 ...
	 * http://localhost:8081/diagnosticsDetail/522119?xmode=debug
	 */
	@RequestMapping(value = "/diagnosis/syschronize2his/zy/split", method = RequestMethod.GET)
	 ...
	 * @param times 患者就诊次数
	 * */
	@RequestMapping(value = "/diagnosis/his/delete/zy/split", method = RequestMethod.GET)
