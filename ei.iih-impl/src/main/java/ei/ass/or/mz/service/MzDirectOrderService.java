...
public interface MzDirectOrderService {
	/**
	 *  【医嘱】查询服务（单记录）
	 * @param String id
	 * @return Order
	 * @
	 */
	@RequestMapping(value = "/order/mz/direct/{orPk}", method = RequestMethod.GET)
	 ...
	 * @
	 */
	@RequestMapping(value = "/orders/mz/direct/", method = RequestMethod.GET)
