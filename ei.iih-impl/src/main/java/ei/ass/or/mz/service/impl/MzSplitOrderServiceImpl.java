package ei.ass.or.mz.service.impl;
...
import ei.ass.or.mz.dao.MzSplitOrderDao;
 ...
 * 医嘱视图
 */
public class MzSplitOrderServiceImpl implements MzSplitOrderService {
	 ...
	 */
	@Override
	public ArrayResult<OrderModel> search(String patient_id,String times, String longOrF,String enTypeCode,String currentPageIndex,
			String pageSize) {
		...
		)	
		{
			...
			List<OrderPo> poList = this.orderDao.getOrderListByEnSn(patient_id,times,longOrF/*,options*/);
