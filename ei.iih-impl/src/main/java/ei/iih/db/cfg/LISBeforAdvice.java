...
public class LISBeforAdvice implements MethodBeforeAdvice {

	/**
	 * 构造器
	 */
	public LISBeforAdvice() {
	...
	public void before(Method method, Object[] args, Object target)
			throws Throwable {
		CustomerContextHolder.setCustomerType(CustomerContextHolder.DATASOURCE_LIS);
