...
public interface LabReportService {
	 ...
	 */
	@RequestMapping(value = "/ei/lab/reports", method = RequestMethod.GET)
     ...
     * @author meng_xinhua
     */
    ArrayResult<LabReport> searchForCis(@RequestParam("enPk") String enPk,@RequestParam("currentPageIndex") String currentPageIndex ,@RequestParam("pageSize") String pageSize) ;
}
