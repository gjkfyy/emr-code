 ...
 * 会诊就诊列表
 */
public interface HisConsMrAmrService {
	 ...
	 * */
		@RequestMapping(value = "/ei/mramr/cons/his/zy", method = RequestMethod.GET)
	   List<Map<String, Object>> getZYList(
		 ...
		 * @param orderEndTime   会诊区间结束时间
		 * */
			@RequestMapping(value = "/ei/mramr/cons/his/mz", method = RequestMethod.GET)
