Ext.MsgTip = function(){
    ...
    return {
        msg : function(title, message,autoHide,pauseTime){
            if(!msgCt){
                msgCt = Ext.DomHelper.insertFirst(document.body, {id:'msg-div22',style:'position:absolute;top:80px;height:160px;width:230px;margin:0 auto;z-index:20000;'}, true);
            }
            msgCt.alignTo(document, 'r-br');
            //给消息框右下角增加一个关闭按钮
