Ext.define('iih.mr.wr.mr_apply.block.MrApplySearchBlock',{
	extend : 'Xap.ej.block.FormBlock',
	
	requires: [],

	alias:'widget.mrapplysearchblock',
...
//	        searchParam: {'deptCd': IMER_GLOBAL.department.code},
			...
			callback:function(newValue,oldValue,record){  //在grid选择记录后的回调函数
				var view = this.up('mrapplylistview');
...
//			margin:'10 70 10 0',
	        ...
	        items: [{
	            ...
	            handler:function(btn,e){
	                var block = btn.up('mrapplysearchblock');
	                ...
	                var view = btn.up('mrapplylistview');
	                var block = btn.up('mrapplysearchblock');
	                var form = block.down('xapform');
