Ext.define('iih.mr.wr.nsv.action.ConfimCreateNurScoreDocAction', {
	...
	doExecute: function(context) {
		...
		//}else if(tabName=='createomrdocview'){
			var grid=Ext.getCmp('createnurscoredocview').down('xapgrid');
...
////					alert(mrSelection.length);
//				}
			var nmrCategoryCode= Ext.getCmp('nurScoreCategoryCode');
			var block= Ext.getCmp('nurscorepropertyblock');
...
//			var data = {'typeCode':typeCode,'encounterPk':encounterSn}
				var nurscoredoceditview = Ext.getCmp('nurscoredoceditview');
				nurscoredoceditview.opType='new';
				nurscoredoceditview.medicalRecord=medicalRecord;
		        var initChain =  nurscoredoceditview.getActionChain('init');
		        initChain.execute();
         //}
            owner.ownerCt.close();
            return
