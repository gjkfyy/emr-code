Ext.define('iih.mr.wr.nsv.action.NurScoreTemplateSearchAction', {
...
//        console.log(url);
    ...
    onSuccess: function(operation) {
        ...
        // TODO 数据格式就这样了？
        var view=Ext.getCmp('createnurscoredocview');
        var bottom = view.getBlock('bottom');
		var confim=bottom.down('button[name=confimUpPro]');
