Ext.define('iih.mr.qa.qa_work_assistant.view.VitalSignHelperView', {
	extend : 'Xap.ej.template.BaseTemplate',

	requires: [
		'iih.mr.qa.qa_work_assistant.block.VitalSignHelperBlock',
	...
	xapConfig: {
		blocks: {
			'list': {
				xclass: 'iih.mr.qa.qa_work_assistant.block.VitalSignHelperBlock'
			}
        },
		actions: {
			'refresh': {
