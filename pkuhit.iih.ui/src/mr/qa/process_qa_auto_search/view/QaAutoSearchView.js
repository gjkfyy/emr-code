Ext.define('iih.mr.qa.process_qa_auto_search.view.QaAutoSearchView',{
	...
	requires:[
		...
		'Xap.ej.element.grid.Grid',
   		...
   		'iih.mr.qa.process_qa_auto_search.view.QaAutoInitView',
   		'iih.mr.qa.process_qa_auto_search.block.QaAutoSearchGridBlock',
   		'iih.mr.qa.process_qa_auto_search.action.QaAutoSearchAction',
   		'iih.mr.qa.process_qa_search.action.JudgeBtnAction',
   		'iih.mr.qa.process_qa_auto_search.action.ToQaAutoDefectAction',
