...
//  				{ header: '质控日期', dataIndex: 'crtTime',xtype: 'xapdatecolumn',width:130},
                ...
                { header: '主管医师编码', dataIndex: 'currentManageDoctorId',field: 'textfield',type: 'string',hidden:true},
                { header: '出诊科室编码', dataIndex: 'deptCd' ,field: 'textfield',type: 'string',hidden:true},
                { header: '主管医师', dataIndex: 'currentManageDoctorName',field: 'textfield',type: 'string',flex:1 },
                { header: '出诊科室', dataIndex: 'nm' ,field: 'textfield',type: 'string',width:300},
                { header: '缺陷数', dataIndex: 'defectCount',field: 'textfield',type: 'int',width:300 }
